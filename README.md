...
应用显示名称为 **Harmony VPN**，当前开发版本为 **0.23.0/code44**。这是独立的开发项目，参考 v2rayNG 的功能与分享链接格式，不是 v2rayNG 或华为的官方客户端。完整 Android 功能对等和商店发布尚未完成。
...
2026-09-22 已在一台 API 26、ARM64 鸿蒙电脑上完成完整核心的短时实测：两次连接、三次代理 DNS／HTTPS 检查及两次断开清理通过，并检查宽窄窗口、大字号和诊断摘要导出。睡眠唤醒及长期后台尚未验收，详见[真实电脑验证记录](HarmonyVpnLab/docs/phase27-real-pc.md)。
