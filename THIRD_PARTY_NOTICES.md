...
| --- | --- | --- | --- |
| v2rayN built-in whitelist | 7.24.9; commit `521230c40d5c180bc0727cf4003907edfae5a3e0` | [GPL-3.0](HarmonyVpnLab/rules/LICENSE-v2rayN) | Preserved rule order; app inbound scope and local outbound tags. [Source and provenance](HarmonyVpnLab/rules/README.md). |
| Loyalsoldier GeoData | `v2ray-rules-dat` release `202609222357` | [Upstream GPL-3.0, GeoIP CC-BY-SA-4.0, and source-specific notices](HarmonyVpnLab/rules/LICENSE-Loyalsoldier) | Complete CN/PRIVATE IP and CN/PRIVATE/GOOGLE domain categories retained byte-for-byte; other categories omitted. [Source lock and attribution](HarmonyVpnLab/rules/sources.lock.json). |
